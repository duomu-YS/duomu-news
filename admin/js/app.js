window.app = {
    ...
    /* 
    portalIndexUrl: "http://localhost:8080/duomu-news/portal/index.html",           // 门户首页地址
    writerIndexUrl: "http://localhost:8080/duomu-news/writer/contentMng.html",      // 作家中心首页
    writerInfoUrl: "http://localhost:8080/duomu-news/writer/accountInfo.html",     // 用户信息完善页面
    userServerUrl: "http://192.168.1.5:8003",   // 用户服务后端接口地址
    */

    portalIndexUrl: "http://www.duomunews.com:9090/duomu-news/portal/index.html",           // 门户首页地址
    writerLoginUrl: "http://writer.duomunews.com:9090/duomu-news/writer/passport.html",      // 登录页面
    writerIndexUrl: "http://writer.duomunews.com:9090/duomu-news/writer/contentMng.html",      // 作家中心首页
    writerInfoUrl: "http://writer.duomunews.com:9090/duomu-news/writer/accountInfo.html",     // 用户信息完善页面
    
    adminCenterUrl: "http://admin.duomunews.com:9090/duomu-news/admin/contentReview.html",     // 运营管理平台主页
    adminLoginUrl: "http://admin.duomunews.com:9090/duomu-news/admin/login.html",        // admin后台登录页面
    adminIndexUrl: "http://admin.duomunews.com:9090/duomu-news/admin/userList.html",        // admin后台默认页面
    
    userServerUrl: "http://user.duomunews.com:8003",        // 用户服务后端接口地址
    fsServerUrl: "http://files.duomunews.com:8004",         // 文件服务后端接口地址
    adminServerUrl: "http://admin.duomunews.com:8005",      // 运营管理服务后端接口地址
    articleServerUrl: "http://article.duomunews.com:8001",      // 文章服务后端接口地址
